...
const ConsultationService: React.FC<ConsultationServiceProps> = ({
  ...
  return (
    <div 
      className={`relative overflow-hidden rounded-xl bg-gradient-to-b from-background/60 to-background/30 backdrop-blur-sm border ${color} group animate-fade-in`}
  ...
  return (
    <section id="consultation-services" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in" style={{ animationDelay: '50ms' }}>
