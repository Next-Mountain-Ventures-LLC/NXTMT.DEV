...
const APIComparisonTable: React.FC<{ solutions: APISolution[], activeTab: string }> = ({ solutions, activeTab }) => {
  ...
  return (
    <div 
      className="bg-white/5 backdrop-blur-sm rounded-xl border border-teal-500/30 overflow-hidden animate-fade-in"
    >
  ...
  return (
    <section id="api-solutions" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12 animate-fade-in" style={{ animationDelay: '100ms' }}>
        ...
        {/* Tabs */}
        <div className="flex overflow-x-auto no-scrollbar mb-10 animate-fade-in" style={{ animationDelay: '200ms' }}>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 animate-fade-in" style={{ animationDelay: '400ms' }}>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 animate-fade-in" style={{ animationDelay: '500ms' }}>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 animate-fade-in" style={{ animationDelay: '600ms' }}>
