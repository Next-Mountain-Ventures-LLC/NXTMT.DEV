...
const BrandingServices: React.FC = () => {
  ...
  const handleTabChange = (tabId: string) => {
    ...
    // Change tab immediately but animate content
    setActiveTab(tabId);
  ...
  return (
    <section id="branding-services" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Tabs Navigation */}
        <div className="flex overflow-x-auto no-scrollbar mb-10 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '200ms' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Image */}
          <div className="rounded-xl overflow-hidden animate-content-fade">
            <img 
              src={activeService.image} 
              alt={activeService.title}
              className="w-full h-[400px] object-cover"
              onError={(e) => {
                e.currentTarget.src = "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3";
              }}
            />
          </div>
