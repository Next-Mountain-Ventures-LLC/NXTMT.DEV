...
const PartnershipTier: React.FC<PartnershipTierProps> = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center py-12 relative">
      {/* Left - icon and title */}
...
const PartnershipSectionSimplified: React.FC = () => {
  const partnershipTiers = [
    {
      ...
      features: [
        { 
          ...
          description: "Professional site designed specifically for your brand"
        },
        { 
    ...
    },
    {
      ...
      features: [
        { 
          ...
          description: "Advanced websites with premium features and capabilities"
        },
        { 
    ...
    },
    {
      ...
      features: [
        ...
        { 
          icon: <TreeDeciduous className="w-5 h-5 text-accent" />,
  ...
  return (
    <section id="partnerships" className="py-16 relative overflow-hidden bg-gradient-to-t from-background/80 to-background">
      {/* Background accents */}
...
export default PartnershipSectionSimplified;
