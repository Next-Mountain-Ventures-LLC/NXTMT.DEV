...
// Ultra-simplified component to avoid any issues
export default function FixedSimpleWorkCarousel() {
  ...
  const projects = [
    ...
    {
      image: twistBeforeImg.src,  // Using the Twist image for Tech Startup Branding
